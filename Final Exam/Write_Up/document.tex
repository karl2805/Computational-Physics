...
\begin{figure}[h]
	...
	\caption{The Euler integration method performed for 3 different step sizes. The Earth's initial position was set to 1 AU to the right of Sun which is represented by the yellow circle in each plot. The initial velocity was set the the Keplerian velocity}
