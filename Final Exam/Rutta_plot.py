...
data_day = np.genfromtxt("Day_Rutta.csv",delimiter=",",skip_header=0)
data_half_day = np.genfromtxt("halfday_Rutta.csv",delimiter=",",skip_header=0)
data_quarter_day = np.genfromtxt("quarterday_Rutta.csv",delimiter=",",skip_header=0)

data_energy = np.genfromtxt("Energy_Rutta.csv",delimiter=",",skip_header=0)
...
ax.set_title("Orbit of Earth using Rutta-Kunda Method", fontsize=15)
...
ax_energy.set_title('Energy vs Time for Rutta-Kunda Method')
